...
def main(uri_set=None):
    ...
    done_uris_path=data_path+"updated_done_uris.csv"
    done_uris=get_categories(done_uris_path)

    d = DBPediaHandler()
    etradis_category = ["http://localhost:9999/etradis/Event",
                        "http://localhost:9999/etradis/Agent",
                        "http://localhost:9999/etradis/CulturalArtifact",
                        "http://localhost:9999/etradis/MaterialObject",
                        "http://localhost:9999/etradis/Place",
                        "http://localhost:9999/etradis/TopicalConcept",
                        "http://localhost:9999/etradis/TimePeriod",
                        "http://localhost:9999/etradis/Miscellaneous"]
    ...
    for uri in etradis_category:
       ...
       if isEmpty:
        ...
        for base_uri in base_uris:
            ...
            with open(data_path + "updated_done_uris.csv", 'a') as outfile:
